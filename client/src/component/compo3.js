...
function Compo3() {
    ...
    let viow = async () => {
        let find = await axios.get('https://sa-mern-user.onrender.com/view');
        setalluser(find.data);
    }
    let handleDelete = async (id) => {
        await axios.delete('https://sa-mern-user.onrender.com/duser/' + id)
    ...
    let edit = async (id) => {
        await axios.get('https://sa-mern-user.onrender.com/getid/' + id)
            .then(rest => {
    ...
    let update = async (id) => {
        await axios.put('https://sa-mern-user.onrender.com/updateuser/' + id, { fname: fedit, email: eedit, mobile: medit, address: aedit, address2: aaedit, country: cedit, state: sedit, pincode: zedit })
            .then(res => console.log(res))
            .catch(err => console.log("err"))
        viow()
        setOpen(false)
